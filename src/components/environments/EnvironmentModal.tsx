...
export const EnvironmentModal: React.FC<EnvironmentModalProps> = ({
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm">
            <div
                className="bg-[#121212] border border-[#333333] rounded-2xl shadow-2xl w-full max-w-3xl overflow-hidden shadow-black/50"
            ...
            >
                <div className="flex justify-between items-center p-6 border-b border-[#252525]">
                    ...
                    <button onClick={onClose} className="p-2 text-[#A1A1AA] hover:text-[#E4E3E0] hover:bg-[#222222] rounded-full transition-colors">
                        <X size={20} />
                    </button>
                </div>
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6">
                    ...
                    {/* Footer Actions */}
                    <div className="flex justify-end gap-3 pt-6 border-t border-[#252525]">
                        <button
                            type="button"
                            onClick={onClose}
